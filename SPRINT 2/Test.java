/**
 * This is the Testing class. It has basic testing functions to make sure getter/setters are working as they should
...
public class Test {
    ...
    /** 
     * various testing that adds rating to new instances of memes of different users and keeps track, then returns all computations.
     * @param args
     */
